...
contract RebalanceTestFee100 is Test {
    ...
    function _createUniswapPool() internal {
        ...
        uniswapPool = IPoolInitializer(NonfungiblePositionManager).createAndInitializePoolIfNecessary(VETH, WETH, uint24(100), uint160(79228162514264337593543950336));
